...
char username[] = "06cc93e0-ec41-11e8-8e60-53d8c8eabc71";
char password[] = "bc56f666f5ca23747947c064543215e8b6cfdc83";
char clientID[] = "59a0d2f0-8338-11e9-9636-f9904f7b864b";

// Mac address should be different for each device in your LAN
byte arduino_mac[] = { 0xDE, 0xED, 0xBA, 0xFE, 0xFE, 0xED };
IPAddress arduino_ip(192, 168, 43, 12);
